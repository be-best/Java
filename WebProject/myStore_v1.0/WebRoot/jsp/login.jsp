...
<div class="container"  style="width:100%;height:560px;background:#FF2C4C url('${ pageContext.request.contextPath }/images/backgd3.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
...
<form class="form-horizontal" action="${ pageContext.request.contextPath }/UserServlet" method="post">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
    <button type="submit" class="btn btn-info" id="add" name="add">登录</button>
