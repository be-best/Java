...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div>
				<hr/>
				<form id="orderform" name="orderform" action="${ pageContext.request.contextPath }/OrderServlet" method="post" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
					<!-- 传递隐藏的信息，避免在浏览器网址上面显示 -->
