	...
	<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp" method="post">
			...
			<ul class="pagination" style="text-align:center; margin-top:10px;">
						...
						<c:if test="${ pageBean.currPage != 1 }">
								<li>
									<a href="${ pageContext.request.contextPath }/AdminProductServlet?method=searchOldProduct&currPage=${ pageBean.currPage - 1}&productKeywords=${ productKeywords }" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
								</li>
							</c:if>
							...
							<c:forEach var="i" begin="1" end="${ pageBean.totalPage }">
								...
								<c:if test="${ pageBean.currPage != i }">
									<li><a href="${ pageContext.request.contextPath }/AdminProductServlet?method=searchOldProduct&currPage=${ i }&productKeywords=${ productKeywords }">${ i }</a></li>
								</c:if>
							</c:forEach>
							...
							<c:if test="${ pageBean.currPage != pageBean.totalPage }">
								<li>
									<a href="${ pageContext.request.contextPath }/AdminProductServlet?method=searchOldProduct&currPage=${ pageBean.currPage + 1}&productKeywords=${ productKeywrods }" aria-label="Next">
										<span aria-hidden="true">&raquo;</span>
									</a>
								</li>
							</c:if>
