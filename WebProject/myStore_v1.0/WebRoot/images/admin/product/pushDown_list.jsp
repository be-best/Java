...
<HTML>
	...
	<body>
		<br>
		<form action="${ pageContext.request.contextPath }/AdminProductServlet?method=searchOldProduct&currPage=1" class="navbar-form navbar-right" method="post" role="search">
...
<%-- 					 <tr align="center">
			...
			<ul class="pagination" style="text-align:center; margin-top:10px;">
						...
						<c:if test="${ pageBean.currPage != 1 }">
								<li>
									<a href="${ pageContext.request.contextPath }/AdminProductServlet?method=findByPushDown&currPage=${ pageBean.currPage - 1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
								</li>
							</c:if>
							...
							<c:forEach var="i" begin="1" end="${ pageBean.totalPage }">
								...
								<c:if test="${ pageBean.currPage != i }">
									<li><a href="${ pageContext.request.contextPath }/AdminProductServlet?method=findByPushDown&currPage=${ i}">${ i }</a></li>
								</c:if>
							</c:forEach>
							...
							<c:if test="${ pageBean.currPage != pageBean.totalPage }">
								<li>
									<a href="${ pageContext.request.contextPath }/AdminProductServlet?method=findByPushDown&currPage=${ pageBean.currPage + 1}" aria-label="Next">
										<span aria-hidden="true">&raquo;</span>
									</a>
								</li>
							</c:if>
