<%@page import="bull.Utils.CookieUtils"%>
<%@page import="bull01.VisitTime.User"%>
...
<html>
	...
	<head>
		...
		<title>会员登录</title>
		<link rel="stylesheet" href="/Web11/history/css/bootstrap.min.css" type="text/css" />
		<script src="/Web11/history/js/jquery-1.11.3.min.js" type="text/javascript"></script>
		<script src="/Web11/history/js/bootstrap.min.js" type="text/javascript"></script>
	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<div class="col-md-2">
				<a href="${pageContext.request.contextPath }/ProductServlet?id=2">
					<img src="/Web11/history/products/1/cs10002.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="/Web11/cart/product_info2.htm" style='color:green'>圆白菜</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="${pageContext.request.contextPath }/ProductServlet?id=3">
					<img src="/Web11/history/products/1/cs10003.jpg" width="170" height="170" style="display: inline-block;">
				</a>
			...
			<div class="col-md-2">
				<a href="${pageContext.request.contextPath }/ProductServlet?id=4">
					<img src="/Web11/history/products/1/cs10004.jpg" width="170" height="170" style="display: inline-block;">
				</a>
			...
			<div class="col-md-2">
				<a href="${pageContext.request.contextPath }/ProductServlet?id=5">
					<img src="/Web11/history/products/1/cs10005.jpg" width="170" height="170" style="display: inline-block;">
				</a>
			...
			<div class="col-md-2">
				<a href="${pageContext.request.contextPath }/ProductServlet?id=6">
					<img src="/Web11/history/products/1/cs10006.jpg" width="170" height="170" style="display: inline-block;">
				</a>
			...
			<div class="col-md-2">
				<a href="product_info.htm">
					<img src="/Web11/history/products/1/cs10007.jpg" width="170" height="170" style="display: inline-block;">
				</a>
			...
			<div class="col-md-2">
				<a href="product_info.htm">
					<img src="/Web11/history/products/1/cs10008.jpg" width="170" height="170" style="display: inline-block;">
				</a>
		...
		<div style="margin-top:50px;">
			<img src="/Web11/history/image/footer.jpg" width="100%" height="78" alt="我们的优势" title="我们的优势" />
		</div>
